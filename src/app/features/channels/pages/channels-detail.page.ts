        ...
        <ng-template pTemplate="header">
          <div class="flex justify-content-between align-items-center p-3">
            ...
            <div class="flex gap-2">
              <p-button label="Editar" icon="pi pi-pencil" (onClick)="goToEdit()" [disabled]="!channel"></p-button>
          ...
          <div class="detail-section" *ngIf="channel.type === 'telegram' && channel.telegramConfig">
            ...
            <div class="detail-grid">
              ...
              <div class="detail-item">
                ...
                <span [class]="'badge ' + (channel.telegramConfig.isWebhookSet ? 'badge-success' : 'badge-danger')">
