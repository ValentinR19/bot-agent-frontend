...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, CardModule, ButtonModule, InputTextModule, InputNumberModule, BadgeModule, ChipModule, DividerModule, AccordionModule, SliderModule],
  template: `
    <p-card header="Búsqueda RAG Semántica">
      ...
      <div class="search-form">
        <div class="flex gap-3 mb-3">
          ...
          <p-button label="Buscar" icon="pi pi-search" (onClick)="onSearch()" [loading]="isSearching" [disabled]="!query"></p-button>
          ...
          <p-accordionTab header="Parámetros avanzados">
            <div class="grid">
              <div class="col-6">
                ...
                <p-inputNumber id="topK" [(ngModel)]="topK" [min]="1" [max]="20" [showButtons]="true" class="w-full"></p-inputNumber>
              ...
              <div class="col-6">
                ...
                <div class="flex align-items-center gap-3">
                  <p-slider [(ngModel)]="minSimilarityPercent" [min]="0" [max]="100" class="flex-1"></p-slider>
                  <span class="font-semibold">{{ minSimilarityPercent }}%</span>
                </div>
  ...
  styles: [
    `
      ...
      ::ng-deep .custom-chip-secondary {
        background: #6b7280;
        color: white;
      }

      ::ng-deep .custom-chip-info {
        background: #3b82f6;
        color: white;
      }

      ::ng-deep .custom-chip-primary {
        background: #10b981;
        color: white;
      }

      ::ng-deep .p-accordion .p-accordion-header-link {
...
export class RagSearchComponent implements OnInit, OnDestroy {
  ...
  onSearch(): void {
    ...
    const request: RagSearchRequest = {
      query: this.query,
      topK: this.topK,
      minSimilarity: this.minSimilarityPercent / 100,
    };
